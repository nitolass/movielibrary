    ...
    <div class="py-8" x-data="{ loaded: false }" x-init="setTimeout(() => loaded = true, 100)">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8 transition-all duration-700 opacity-0 translate-y-4"
            ...
            <div class="relative p-10 bg-gradient-to-br from-gray-900 to-[#16181c] border border-white/10 rounded-3xl shadow-2xl overflow-hidden group">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                    ...
                    <div class="hidden md:block">
                        <a href="{{ route('user.movies.index') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-white/5 hover:bg-yellow-400 hover:text-black border border-white/10 hover:border-yellow-400 rounded-xl text-white font-bold transition-all duration-300 group/btn">
                            {{ __('Ir al catálogo') }}
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {{-- CARD EXPLORAR --}}
                <a href="{{ Route::has('user.movies.index') ? route('user.movies.index') : '#' }}" class="group relative p-1 rounded-3xl bg-gradient-to-b from-white/10 to-white/5 hover:from-yellow-400/50 hover:to-yellow-600/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(250,204,21,0.2)]">
                ...
                {{-- CARD FAVORITOS --}}
                <a href="{{ route('user.favorites') }}" class="group relative p-1 rounded-3xl bg-gradient-to-b from-white/10 to-white/5 hover:from-red-400/50 hover:to-red-600/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(248,113,113,0.2)]">
                    <div class="relative h-full p-8 bg-[#0f1115] rounded-[22px] flex flex-col items-start overflow-hidden">
