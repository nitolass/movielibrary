...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-white font-['Outfit']">{{ __('Mis Puntuaciones') }} ⭐</h1>
            <p class="text-gray-400 text-sm mt-1">{{ __('Las películas que has valorado.') }}</p>
        </div>
                    ...
                    <div class="bg-[#16181c] rounded-xl overflow-hidden hover:scale-105 transition-transform duration-300 shadow-lg group">
                        ...
                        <a href="{{ route('user.movies.show', $movie) }}">
                            <div class="relative aspect-[2/3]">
                                ...
                                {{-- Puntuación (asumiendo que viene en pivot o similar, aquí lo dejo estático como en tu ejemplo) --}}
                            ...
                            <div class="p-3">
                                ...
                                <p class="text-gray-500 text-xs">{{ __('Tu reseña') }}: "..."</p>
                            </div>
                        </a>
                    </div>
                @endforeach
