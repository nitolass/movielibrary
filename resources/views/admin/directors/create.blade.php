...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('directors.index') }}" class="text-gray-400 hover:text-white transition-colors">
        ...
        <div class="bg-[#0f1115] border border-white/5 rounded-xl p-8 shadow-xl max-w-2xl mx-auto">
            <form action="{{ route('directors.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                {{-- Biografía (Corregido de 'bio' a 'biography') --}}
                <div>
                ...
                <div class="flex justify-end gap-4 pt-4 border-t border-white/5">
                    <a href="{{ route('directors.index') }}" class="px-6 py-3 bg-gray-800 text-gray-300 font-bold rounded-xl hover:bg-gray-700 transition-colors">
                        Cancelar
                    </a>
